...
# Still need to answer why nnot norm instead of standardize
```
...
corrplot(correlation, tl.srt = 0, method = "number", sig.level = 0.01)
#help(corrplot)
...
#2b
lamda = 0.5
A_RR = solve(t(full_TC) %*% full_TC + diag(nrow(t(full_TC))) * lamda) %*% t(full_TC) %*% scaled_X
