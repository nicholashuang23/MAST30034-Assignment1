...
full_TC = matrix(c(TC1, TC2, TC3, TC4, TC5, TC6), 240, 6)
full_TC = scale(full_TC)
...
corrplot.mixed(correlation, tl.srt = 0, upper = 'color')
...
max.col(RR_corr)
max.col(LSR_corr)
c_tlsr = sum(abs(diag(RR_corr)))
c_trr = sum(abs(diag(LSR_corr)))
